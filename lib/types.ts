...
export type AccountType = 'group' | 'box' | 'client' | 'supplier' | 'expense' | 'revenue' | 'account' | 'subscription' | 'company' | 'individual' | 'both' | '';
...
export interface MonthlyProfit {
  ...
  notes?: string;
  currency?: Currency;
  partners?: PartnerShare[]; // For manual entries
}
