...
const VOUCHER_TYPE_ALIASES: Record<string, NormalizedVoucherType> = {
  ...
  general_journal: 'journal_voucher',
  manual_journal: 'journal_voucher',
  adjustment: 'journal_voucher',
  remittance: 'remittance',
  transfer: 'transfer',
  standard_receipt: 'standard_receipt',
  receipt_voucher: 'standard_receipt',
  receipt: 'standard_receipt',
  distributed_receipt: 'distributed_receipt',
  distributedReceipt: 'distributed_receipt',
  custom_receipt: 'distributed_receipt',
  allocated_receipt: 'distributed_receipt',
  payment: 'payment',
  payment_voucher: 'payment',
  manualExpense: 'manualExpense',
  manual_expense: 'manualExpense',
  expense_voucher: 'manualExpense',
  ...
  subscription_installment_receipt: 'subscription',
  ...
  segment_payment: 'segment',
  profit_distribution: 'profit-sharing',
  profit_sharing: 'profit-sharing',
  'profit-sharing': 'profit-sharing',
  profitShare: 'profit-sharing',
  profit_share: 'profit-sharing',
  profitSharePayment: 'profit-sharing',
  profit_share_payment: 'profit-sharing',
  partner_share: 'profit-sharing',
  partner_distribution: 'profit-sharing',
  refund: 'refund',
  exchange: 'exchange',
  void: 'void',
  exchange_transaction: 'exchange_transaction',
  exchange_payment: 'exchange_payment',
  exchange_settlement: 'exchange_adjustment',
