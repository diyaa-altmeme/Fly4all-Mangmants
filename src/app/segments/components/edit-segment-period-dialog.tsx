...
import { Loader2, PlusCircle, Calendar as CalendarIcon, Trash2, Pencil, Percent } from 'lucide-react';
import { z } from 'zod';
...
const EditCompanyForm = ({ entryData, allCompanyOptions, partnerOptions, onSave, onCancel }: { 
    ...
    const form = useForm<CompanyEntryFormValues>({
        ...
        defaultValues: {
            ...
            ticketProfitPercentage: entryData.ticketProfitPercentage || 50,
            visaProfitPercentage: entryData.visaProfitPercentage || 100,
            hotelProfitPercentage: entryData.hotelProfitPercentage || 100,
            groupProfitPercentage: entryData.groupProfitPercentage || 100,
            alrawdatainSharePercentage: entryData.alrawdatainSharePercentage || 50,
        },
    });
         ...
         <Form {...form}>
            <form onSubmit={form.handleSubmit(onSave)} className="p-4 bg-muted/50 rounded-lg space-y-4">
                ...
                <div className="p-3 border rounded-md bg-background/50 space-y-3">
                    <h4 className="font-semibold text-sm">إعدادات العمولة والتوزيع</h4>
                        <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
                        <FormField control={form.control} name="ticketProfitPercentage" render={({ field }) => ( <FormItem><FormLabel>أرباح التذاكر</FormLabel><FormControl><InputWithPercentage field={field} /></FormControl><FormMessage /></FormItem> )}/>
                        <FormField control={form.control} name="visaProfitPercentage" render={({ field }) => ( <FormItem><FormLabel>أرباح الفيزا</FormLabel><FormControl><InputWithPercentage field={field} /></FormControl><FormMessage /></FormItem> )}/>
                        <FormField control={form.control} name="hotelProfitPercentage" render={({ field }) => ( <FormItem><FormLabel>أرباح الفنادق</FormLabel><FormControl><InputWithPercentage field={field} /></FormControl><FormMessage /></FormItem> )}/>
                        <FormField control={form.control} name="groupProfitPercentage" render={({ field }) => ( <FormItem><FormLabel>أرباح الكروبات</FormLabel><FormControl><InputWithPercentage field={field} /></FormControl><FormMessage /></FormItem> )}/>
                        <FormField control={form.control} name="alrawdatainSharePercentage" render={({ field }) => ( <FormItem><FormLabel>حصة الروضتين</FormLabel><FormControl><InputWithPercentage field={field} /></FormControl><FormMessage /></FormItem> )}/>
                    </div>
                </div>
                        ...
                        <Form {...companyForm}>
                            <form onSubmit={companyForm.handleSubmit(handleAddCompanyEntry)} className="space-y-4">
                                ...
                                <div className="p-3 border rounded-md bg-muted/50 space-y-3">
                                    <h4 className="font-semibold text-sm">إعدادات العمولة والتوزيع</h4>
                                     <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
                                        <FormField control={companyForm.control} name="ticketProfitPercentage" render={({ field }) => ( <FormItem><FormLabel>أرباح التذاكر</FormLabel><FormControl><InputWithPercentage field={field} /></FormControl><FormMessage /></FormItem> )}/>
                                        <FormField control={companyForm.control} name="visaProfitPercentage" render={({ field }) => ( <FormItem><FormLabel>أرباح الفيزا</FormLabel><FormControl><InputWithPercentage field={field} /></FormControl><FormMessage /></FormItem> )}/>
                                        <FormField control={companyForm.control} name="hotelProfitPercentage" render={({ field }) => ( <FormItem><FormLabel>أرباح الفنادق</FormLabel><FormControl><InputWithPercentage field={field} /></FormControl><FormMessage /></FormItem> )}/>
                                        <FormField control={companyForm.control} name="groupProfitPercentage" render={({ field }) => ( <FormItem><FormLabel>أرباح الكروبات</FormLabel><FormControl><InputWithPercentage field={field} /></FormControl><FormMessage /></FormItem> )}/>
                                        <FormField control={companyForm.control} name="alrawdatainSharePercentage" render={({ field }) => ( <FormItem><FormLabel>حصة الروضتين</FormLabel><FormControl><InputWithPercentage field={field} /></FormControl><FormMessage /></FormItem> )}/>
                                    </div>
                                </div>
