...
import type { VisaBookingEntry, Client, Supplier, Box, Currency, AppSettings } from "@/lib/types";
    ...
    <div className="space-y-4">
       <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex w-full sm:w-auto items-center gap-2">
                 <AddVisaDialog onBookingAdded={addBookingToState}>
                    <Button><PlusCircle className="me-2 h-4 w-4"/> إضافة طلب جديد</Button>
                 </AddVisaDialog>
