    ...
    return (
        <div className="flex flex-col gap-1 p-2">
             <Dialog modal={false}>
              <NewStandardReceiptDialog onVoucherAdded={onDataChanged}>
                <DialogTrigger asChild>
                  <DropdownMenuItem onSelect={(e) => e.preventDefault()} className="justify-between"><span>سند قبض عادي</span><FileDown className="h-4 w-4" /></DropdownMenuItem>
                </DialogTrigger>
              </NewStandardReceiptDialog>
            </Dialog>
            ...
            <Dialog modal={false}>
              <NewDistributedReceiptDialog onVoucherAdded={onDataChanged}>
                <DialogTrigger asChild>
                  <DropdownMenuItem onSelect={(e) => e.preventDefault()} className="justify-between"><span>سند قبض مخصص</span><GitBranch className="h-4 w-4" /></DropdownMenuItem>
                </DialogTrigger>
              </NewDistributedReceiptDialog>
            </Dialog>
            ...
            <Dialog modal={false}>
              <NewPaymentVoucherDialog onVoucherAdded={onDataChanged}>
                <DialogTrigger asChild>
                  <DropdownMenuItem onSelect={(e) => e.preventDefault()} className="justify-between"><span>سند دفع</span><FileUp className="h-4 w-4" /></DropdownMenuItem>
                </DialogTrigger>
              </NewPaymentVoucherDialog>
            </Dialog>
             ...
             <Dialog modal={false}>
                <NewExpenseVoucherDialog onVoucherAdded={onDataChanged}>
                    <DialogTrigger asChild>
                    <DropdownMenuItem onSelect={(e) => e.preventDefault()} className="justify-between"><span>سند مصاريف</span><Banknote className="h-4 w-4" /></DropdownMenuItem>
                    </DialogTrigger>
                </NewExpenseVoucherDialog>
            </Dialog>
            ...
            <Dialog modal={false}>
                <NewJournalVoucherDialog onVoucherAdded={onDataChanged}>
                    <DialogTrigger asChild>
                    <DropdownMenuItem onSelect={(e) => e.preventDefault()} className="justify-between"><span>سند قيد داخلي</span><BookUser className="h-4 w-4" /></DropdownMenuItem>
                    </DialogTrigger>
                </NewJournalVoucherDialog>
            </Dialog>
